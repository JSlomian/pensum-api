 ...
 */
final class Version20250504181929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE positions (id SERIAL NOT NULL, description VARCHAR(255) NOT NULL, abbreviation VARCHAR(30) NOT NULL, title VARCHAR(255) NOT NULL, pensum SMALLINT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE programs (id SERIAL NOT NULL, program_in_majors_id INT NOT NULL, plan_year SMALLINT NOT NULL, semester SMALLINT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subject_lecturers (id SERIAL NOT NULL, subject_id INT NOT NULL, class_type_id INT NOT NULL, user_id INT NOT NULL, subject_hours SMALLINT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, position_id INT DEFAULT NULL, institute_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, pensum SMALLINT DEFAULT NULL, PRIMARY KEY(id))');
